@{
    ...
    FunctionsToExport = 'Get-ShortHelp','Set-TldrConfiguration', 'New-TldrDocument'
    ...
    PrivateData = @{
        PSData = @{
            ...
            LicenseUri = 'https://GitHub.com/PoshCode/tldr/blob/master/LICENSE.md'

            # A URL to the main website for this project.
            ProjectUri = 'https://GitHub.com/PoshCode/tldr'
